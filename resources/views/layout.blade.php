...
<head>
    ...
    <title>@yield('title', 'ÇTBMYO')</title>
...
<div class="container">
    <header class="border-bottom lh-1 py-3">
        <div class="row flex-nowrap justify-content-between align-items-center">
            ...
            <div class="col-4 text-center"><a class="blog-header-logo text-body-emphasis text-decoration-none" href="#">ÇTBMYO</a>
            </div>
...
<footer class="py-5 text-center text-body-secondary bg-body-tertiary">
    @section('footer')
        <p>&copy; Copyright - 2025 <a
                href="https://ctbmyo.comu.edu.tr">ÇTBMYO</a> Çanakkale Onsekiz Mart Üniversitesi</p>
        <p class="mb-0"><a href="#">Yukarıya Dön</a></p>
    @show
</footer>
